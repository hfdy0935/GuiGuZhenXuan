...
defineOptions({ name: 'AttrCategory' });

// 各级分类列表
let { category1List, category2List, category3List } = storeToRefs(useProductAttrStore());
// 选的各级分类id、页数、每页条数
let { category1Id, category2Id, category3Id } = storeToRefs(useProductAttrStore());
// 修改
let { changeCategory1List, changeCategory2List, changeCategory3List, changeCategoryId } = useProductAttrStore();
// 挂载之后发送请求获取c1分类
onMounted(async () => {
